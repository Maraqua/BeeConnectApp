...
import com.marty.beeconnect.adapter.SearchAdapter;
...
public class SearchActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu( Menu menu) {
        ...
        ((ImageView) searchView.findViewById( androidx.appcompat.R.id.search_close_btn)).setImageResource( R.drawable.ic_clear_black_24dp);
        searchView.setQueryHint("Search bees ");
    ...
    private void searchFromDb(String query, boolean b) {
        ...
        Call<List<User>> call = userInterface.searchbees ( params);
